...
<head>
	...
	?>
<meta name="adbit-site-verification" content="b7fd9570539d9ebe120c974cfc7a943cc4d5fc1578da5a11bba84385783ea8a1" />
	...
	<![endif]-->
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$scPosts = $scModel->getAllPosts(array('page' => 1, 'limit' => 10, 'site' => $site, 'noProfiles' => true,
														'noCategories' => true, 'noComments' => true, 'minimize' => true, 'featured' => 1));
				foreach($scPosts as $scKey => $scPost){
					if(!isset($scPost['soundcloud-id']) OR trim($scPost['soundcloud-id']) == ''){
						unset($scPosts[$scKey]);
						continue;
					}
				}
									...
									<div class="pull-right account-links">
										...
										?>
											...
											if(isset($user['meta']['avatar']) AND trim($user['meta']['avatar']) != ''){
												...
												echo '<span class="mini-avatar"><img src="'.SITE_URL.'/files/avatars/default.jpg" alt="" /></span>';
											}
											?>

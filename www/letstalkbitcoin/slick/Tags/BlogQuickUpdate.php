<?php
namespace Tags;
use Core, App, UI, Util, API, App\Blog, App\Account;
class BlogQuickUpdate
{
	public $params = array();
	...
	function __construct($params = array())
	{
		...
		$this->model = new Blog\Submissions_Model;
	...
	public function submitEditForm()
	{
		...
		$appData['perms'] = \App\Meta_Model::getUserAppPerms($this->user['userId'], 'blog');
	...
	public function getForm($postId = 0)
	{
		...
		$push = new UI\Checkbox('pushFront', 'pushFront');
